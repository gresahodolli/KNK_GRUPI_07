...
public class AdminView extends BorderPane {
    ...
    public AdminView(Stage curentStage) {
        ...
        btnUsers.setPrefHeight(100);
        btnUsers.setPrefWidth(200);

        btnCities.setPrefHeight(100);
        btnCities.setPrefWidth(200);

        btnLines.setPrefHeight(100);
        btnLines.setPrefWidth(200);

        btnSchedule.setPrefHeight(100);
